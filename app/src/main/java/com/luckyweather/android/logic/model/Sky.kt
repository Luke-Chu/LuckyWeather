package com.luckyweather.android.logic.model

import com.luckyweather.android.R

/**
 * 彩云天气返回的数据中，天气情况都是一些诸如CLOUDY,WIND之类的天气代码，需要编写一个转换函数将这些天气代码转换成一个Sky对象
 */
...
private val sky = mapOf("CLEAR_DAY" to Sky("晴", R.drawable.ic_clear_day, R.drawable.bg_clear_day),
    ...
    "HEAVY" to Sky("大雪", R.drawable.ic_heavy_snow,R.drawable.bg_snow),
